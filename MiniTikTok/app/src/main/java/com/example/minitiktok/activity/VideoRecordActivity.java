...
//                    Toast.makeText(VideoRecordingActivity.this,"视频已保存: "+mVideoPath,Toast.LENGTH_LONG).show();
    ...
    protected void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(VideoRecordActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(VideoRecordActivity.this, "未授予全部权限！", Toast.LENGTH_SHORT).show();
            finish();
        } else if (ActivityCompat.checkSelfPermission(VideoRecordActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED || ActivityCompat.checkSelfPermission(VideoRecordActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(VideoRecordActivity.this, "未授予全部权限！", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
